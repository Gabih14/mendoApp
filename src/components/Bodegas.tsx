...
const Bodegas: React.FC = () => {
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold mb-6 mt-5">Bodegas</h2>
      <p className="text-lg">
        Sumérgete en el mundo del vino mendocino con nuestras recomendaciones de bodegas y tours enológicos.
      </p>
      {/* En desarrollo */}
